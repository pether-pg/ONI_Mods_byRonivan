...
{
    public class StoragePod_A_Config : IBuildingConfig
    {
        public const string ID = "StoragePod_A";
        public const string DisplayName = "Green Storage Pod";
        ...
        public override void ConfigureBuildingTemplate(GameObject go, Tag prefab_tag)
        {
            ...
            storage.capacityKg = (float)SingletonOptions<ModSettings>.Instance.Capacity_StoragePod_A;
        ...
        public override BuildingDef CreateBuildingDef()
        {
            ...
            BuildingDef def = BuildingTemplates.CreateBuildingDef("StoragePod_A", 1, 1, "storage_pod_a_kanim", 30, 10f, TUNING.BUILDINGS.CONSTRUCTION_MASS_KG.TIER1, MATERIALS.ALL_METALS, 1600f, BuildLocationRule.Anywhere, TUNING.BUILDINGS.DECOR.PENALTY.TIER1, nONE, 0.2f);
            def.Floodable = false;
