...
{
    public class StoragePod_C_Config : IBuildingConfig
    {
        public const string ID = "StoragePod_C";
        public const string DisplayName = "Yellow Storage Pod";
        ...
        public override void ConfigureBuildingTemplate(GameObject go, Tag prefab_tag)
        {
            ...
            storage.capacityKg = (float)SingletonOptions<ModSettings>.Instance.Capacity_StoragePod_C;
        ...
        public override BuildingDef CreateBuildingDef()
        {
            ...
            BuildingDef def = BuildingTemplates.CreateBuildingDef("StoragePod_C", 1, 1, "storage_pod_c_kanim", 30, 10f, TUNING.BUILDINGS.CONSTRUCTION_MASS_KG.TIER4, MATERIALS.ALL_METALS, 1600f, BuildLocationRule.Anywhere, TUNING.BUILDINGS.DECOR.PENALTY.TIER1, nONE, 0.2f);
            def.Floodable = false;
