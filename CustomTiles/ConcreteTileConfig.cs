namespace CustomTiles
{
    ...
    public class ConcreteTileConfig : IBuildingConfig
    {
        ...
        public override BuildingDef CreateBuildingDef()
        {
            ...
            string[] textArray1 = new string[] { SimHashes.Cement.ToString(), "RefinedMetal" };

            EffectorValues nONE = NOISE_POLLUTION.NONE;
            BuildingDef def = BuildingTemplates.CreateBuildingDef("ConcreteTile", 1, 1, "floor_concrete_kanim", 100, 5f, singleArray1, textArray1, 1600f, BuildLocationRule.Tile, BUILDINGS.DECOR.BONUS.TIER1, nONE, 0.2f);
            ...
            def.BlockTileAtlas = GetCustomAtlas(System.IO.Path.Combine(System.IO.Path.Combine("anim", "assets"), "tiles_concrete"), base.GetType(), Assets.GetTextureAtlas("tiles_solid"));
            def.BlockTilePlaceAtlas = GetCustomAtlas(System.IO.Path.Combine(System.IO.Path.Combine("anim", "assets"), "tiles_concrete_place"), base.GetType(), Assets.GetTextureAtlas("tiles_solid"));
            ...
            info.atlas = GetCustomAtlas(System.IO.Path.Combine(System.IO.Path.Combine("anim", "assets"), "tiles_concrete_tops"), base.GetType(), info.atlas);
