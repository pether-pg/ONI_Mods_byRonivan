namespace CustomTiles
{
    ...
    public class FacilityDoorRedConfig : IBuildingConfig
    {
        public const string ID = "FacilityDoorRed";

        public override BuildingDef CreateBuildingDef()
        {
            EffectorValues nONE = TUNING.NOISE_POLLUTION.NONE;
            BuildingDef def = BuildingTemplates.CreateBuildingDef("FacilityDoorRed", 1, 2, "facility_door_red_kanim", 30, 10f, TUNING.BUILDINGS.CONSTRUCTION_MASS_KG.TIER1, MATERIALS.REFINED_METALS, 1600f, BuildLocationRule.Tile, TUNING.BUILDINGS.DECOR.BONUS.TIER1, nONE, 1f);
            def.Entombable = true;
            def.Floodable = false;
