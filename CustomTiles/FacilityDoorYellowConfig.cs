namespace CustomTiles
{
    ...
    public class FacilityDoorYellowConfig : IBuildingConfig
    {
        public const string ID = "FacilityDoorYellow";

        public override BuildingDef CreateBuildingDef()
        {
            EffectorValues nONE = TUNING.NOISE_POLLUTION.NONE;
            BuildingDef def = BuildingTemplates.CreateBuildingDef("FacilityDoorYellow", 1, 2, "facility_door_yellow_kanim", 30, 10f, TUNING.BUILDINGS.CONSTRUCTION_MASS_KG.TIER1, MATERIALS.REFINED_METALS, 1600f, BuildLocationRule.Tile, TUNING.BUILDINGS.DECOR.BONUS.TIER1, nONE, 1f);
            def.Entombable = true;
            def.Floodable = false;
