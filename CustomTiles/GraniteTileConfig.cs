namespace CustomTiles
{
    ...
    public class GraniteTileConfig : IBuildingConfig
    {
        public const string ID = "CustomGraniteTile";
        ...
        {
            float[] singleArray1 = new float[] { 200f };
            string[] textArray1 = new string[] { SimHashes.Granite.ToString() };

            EffectorValues nONE = NOISE_POLLUTION.NONE;
            BuildingDef def = BuildingTemplates.CreateBuildingDef("CustomGraniteTile", 1, 1, "floor_granite_kanim", 100, 5f, singleArray1, textArray1, 1600f, BuildLocationRule.Tile, BUILDINGS.DECOR.BONUS.TIER1, nONE, 0.2f);
            ...
            def.BlockTileAtlas = GetCustomAtlas(System.IO.Path.Combine(System.IO.Path.Combine("anim", "assets"), "tiles_granite"), base.GetType(), Assets.GetTextureAtlas("tiles_solid"));
            def.BlockTilePlaceAtlas = GetCustomAtlas(System.IO.Path.Combine(System.IO.Path.Combine("anim", "assets"), "tiles_granite_place"), base.GetType(), Assets.GetTextureAtlas("tiles_solid"));
            ...
            info.atlas = GetCustomAtlas(System.IO.Path.Combine(System.IO.Path.Combine("anim", "assets"), "tiles_granite_tops"), base.GetType(), info.atlas);
