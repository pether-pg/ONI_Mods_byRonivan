namespace CustomTiles
{
    ...
    public class IgneousTileConfig : IBuildingConfig
    {
        public const string ID = "CustomIgneousTile";
        ...
        public override BuildingDef CreateBuildingDef()
        {
            ...
            string[] textArray1 = new string[] { SimHashes.IgneousRock.ToString() };

            EffectorValues nONE = NOISE_POLLUTION.NONE;
            BuildingDef def = BuildingTemplates.CreateBuildingDef("CustomIgneousTile", 1, 1, "floor_igneous_kanim", 100, 5f, singleArray1, textArray1, 1600f, BuildLocationRule.Tile, BUILDINGS.DECOR.BONUS.TIER1, nONE, 0.2f);
            ...
            def.BlockTileAtlas = GetCustomAtlas(Path.Combine(Path.Combine("anim", "assets"), "tiles_igneous"), base.GetType(), Assets.GetTextureAtlas("tiles_solid"));
            def.BlockTilePlaceAtlas = GetCustomAtlas(Path.Combine(Path.Combine("anim", "assets"), "tiles_igneous_place"), base.GetType(), Assets.GetTextureAtlas("tiles_solid"));
            ...
            info.atlas = GetCustomAtlas(Path.Combine(Path.Combine("anim", "assets"), "tiles_igneous_tops"), base.GetType(), info.atlas);
