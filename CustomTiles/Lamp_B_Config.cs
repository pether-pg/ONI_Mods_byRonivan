namespace CustomTiles
{
    ...
    class Lamp_B_Config : IBuildingConfig
    {
        public const string ID = "Lamp_B";
        ...
        public override BuildingDef CreateBuildingDef()
        {
            ...
            BuildingDef def = BuildingTemplates.CreateBuildingDef("Lamp_B", 1, 1, "fancy_light_kanim", 10, 10f, BUILDINGS.CONSTRUCTION_MASS_KG.TIER1, MATERIALS.REFINED_METALS, 800f, BuildLocationRule.OnCeiling, BUILDINGS.DECOR.BONUS.TIER1, nONE, 0.2f);
