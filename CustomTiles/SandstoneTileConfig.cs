namespace CustomTiles
{
    ...
    public class SandstoneTileConfig : IBuildingConfig
    {
        public const string ID = "CustomSandstoneTile";
        ...
        public override BuildingDef CreateBuildingDef()
        {
            ...
            string[] textArray1 = new string[] { SimHashes.SandStone.ToString() };

            EffectorValues nONE = NOISE_POLLUTION.NONE;
            BuildingDef def = BuildingTemplates.CreateBuildingDef("CustomSandstoneTile", 1, 1, "floor_sandstone_kanim", 100, 5f, singleArray1, textArray1, 1600f, BuildLocationRule.Tile, BUILDINGS.DECOR.BONUS.TIER1, nONE, 0.2f);
            BuildingTemplates.CreateFoundationTileDef(def);
            def.ThermalConductivity = 0.5f; // THERMAL CONDUCTIVITY
            def.Floodable = false;
            ...
            def.BlockTileAtlas = GetCustomAtlas(System.IO.Path.Combine(System.IO.Path.Combine("anim", "assets"), "tiles_sandstone"), base.GetType(), Assets.GetTextureAtlas("tiles_solid"));
            def.BlockTilePlaceAtlas = GetCustomAtlas(System.IO.Path.Combine(System.IO.Path.Combine("anim", "assets"), "tiles_sandstone_place"), base.GetType(), Assets.GetTextureAtlas("tiles_solid"));
            ...
            info.atlas = GetCustomAtlas(System.IO.Path.Combine(System.IO.Path.Combine("anim", "assets"), "tiles_sandstone_tops"), base.GetType(), info.atlas);
