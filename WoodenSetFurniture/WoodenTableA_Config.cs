...
{
    public class WoodenTableAConfig : IBuildingConfig
    {
        public const string ID = "WoodenTableA";
        ...
        public override BuildingDef CreateBuildingDef()
        {
            ...
            BuildingDef def1 = BuildingTemplates.CreateBuildingDef(ID, 3, 1, "wooden_table_empty_kanim", 30, 10f, singleArray1, textArray1, 1600f, BuildLocationRule.OnFloor, TUNING.DECOR.BONUS.TIER1, TUNING.NOISE_POLLUTION.NONE, 0.5f);
            def1.Floodable = true;
