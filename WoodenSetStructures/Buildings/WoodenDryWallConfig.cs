...
namespace WoodenSetStructures
{
    public class WoodenDryWallConfig : IBuildingConfig
    {
        ...
        public override BuildingDef CreateBuildingDef()
        {
            ...
            BuildingDef def1 = BuildingTemplates.CreateBuildingDef(ID, 1, 1, "wooden_walls_kanim", 100, 15f, singleArray1, textArray1, 1600f, BuildLocationRule.Tile, BUILDINGS.DECOR.BONUS.TIER0, nONE, 0.2f);
