...
namespace WoodenSetStructures
{
    public class WoodenMeshTileConfig : IBuildingConfig
    {
        ...
        public override BuildingDef CreateBuildingDef()
        {
            ...
            BuildingDef def = BuildingTemplates.CreateBuildingDef(ID, 1, 1, "floor_wooden_wmesh_kanim", 100, 30f, singleArray1, textArray1, 1600f, BuildLocationRule.Tile, BUILDINGS.DECOR.BONUS.TIER0, nONE, 0.2f);
