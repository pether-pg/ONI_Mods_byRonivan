...
namespace WoodenSetStructures
{
    public class WoodenTileConfig : IBuildingConfig
    {
        ...
        public override BuildingDef CreateBuildingDef()
        {
            ...
            BuildingDef def = BuildingTemplates.CreateBuildingDef("WoodenTile", 1, 1, "floor_wooden_kanim", 100, 5f, singleArray1, textArray1, 1600f, BuildLocationRule.Tile, BUILDINGS.DECOR.BONUS.TIER1, nONE, 0.2f);
